...
public interface ScheduleRepository extends JpaRepository<Schedule, Long> {
     ...
     * @param {Schedule.JobStatus} status - 조회할 작업의 상태 (예: {@link Schedule.JobStatus#SCHEDULED})
     * @returns {List<Schedule>} 해당 상태를 가진 {@link Schedule} 객체들의 리스트
     */
     ...
     * @returns {List<Schedule>} 해당 사용자 ID를 가진 {@link Schedule} 객체들의 리스트
     */
     ...
     * @param {Long} id - 조회할 작업의 고유 ID
     * @param {String} userId - 조회할 사용자의 ID
     * @returns {Optional<Schedule>} 해당 ID와 사용자 ID를 가진 {@link Schedule} 객체를 포함하는 {@link Optional}, 없으면 빈 {@link Optional}
     */
