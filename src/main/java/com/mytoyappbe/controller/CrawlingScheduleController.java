...
import com.mytoyappbe.service.CrawlingScheduleService;
 ...
 * 모든 요청은 {@link CrawlingScheduleService}를 통해 처리됩니다.
 */
@RestController
...
public class CrawlingScheduleController {
     ...
     * Spring에 의해 주입됩니다.
     */
    private final CrawlingScheduleService crawlingScheduleService;
     ...
     * @return 새로 생성된 {@link CrawlingJobSchedule} 객체와 HTTP 상태 코드
     */
    @PostMapping
    public ResponseEntity<CrawlingJobSchedule> addCrawlingSchedule(@RequestBody Map<String, String> payload) {
        ...
        CrawlingJobSchedule newSchedule = crawlingScheduleService.addSchedule(userId, cronExpression);
     ...
     *
     * @return 모든 {@link CrawlingJobSchedule} 객체들의 리스트와 HTTP 상태 코드
     */
    @GetMapping
    public ResponseEntity<List<CrawlingJobSchedule>> getAllCrawlingSchedules() {
        List<CrawlingJobSchedule> schedules = crawlingScheduleService.getAllSchedules();
    ...
    public ResponseEntity<Void> cancelCrawlingSchedule(@PathVariable Long id) {
        return crawlingScheduleService.cancelSchedule(id)
     ...
     * @return 업데이트된 {@link CrawlingJobSchedule} 객체와 HTTP 상태 코드
     */
    @PutMapping("/{id}")
    public ResponseEntity<CrawlingJobSchedule> updateCrawlingSchedule(
        ...
        return crawlingScheduleService.updateSchedule(id, newCronExpression)
