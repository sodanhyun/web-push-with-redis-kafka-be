package com.mytoyappbe.scheduler;
...
public class DynamicScheduler {
     ...
     * {@link CrawlingJobSchedule}의 ID를 키로, 예약된 작업의 {@link ScheduledFuture} 객체를 값으로 가집니다.
     ...
     */
    public void scheduleJob(CrawlingJobSchedule jobSchedule) {
     ...
     * <p>
     * 이 클래스는 {@link DynamicScheduler}가 의존하는 {@link ThreadPoolTaskScheduler}를 Spring 컨텍스트에 등록합니다.
     */
    @Component
